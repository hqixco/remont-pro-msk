  ...
  return (
    <div className="fixed inset-0 z-[120]">
      ...
      >
        ...
        <p className="mx-auto mt-5 max-w-[430px] text-center text-[15px] leading-[1.45] text-[#4f4f4f] sm:mt-6 sm:text-[17px] md:text-[18px] min-[1300px]:mt-[24px]">
          Оставьте номер телефона — мы перезвоним и ответим на все вопросы
        </p>
        ...
        <p className="mx-auto mt-5 max-w-[510px] text-center text-[12px] leading-[1.45] text-[#8a8a8a] sm:mt-6 sm:text-[13px] min-[1300px]:mt-[26px] min-[1300px]:text-[14px]">
