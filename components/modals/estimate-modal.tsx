  ...
  return (
    <div className="fixed inset-0 z-[120]">
      ...
      <div className="absolute left-1/2 top-1/2 w-[602px] -translate-x-1/2 -translate-y-1/2 rounded-[28px] bg-white px-[46px] pb-[40px] pt-[38px] shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
        ...
        <p className="mx-auto mt-[24px] max-w-[470px] text-center text-[18px] leading-[1.45] text-[#4f4f4f]">
          Оставьте номер телефона — подготовим 3 варианта
          <br />
          расчёта под ваш бюджет и свяжемся удобным способом
        </p>
        ...
        <p className="mx-auto mt-[26px] max-w-[420px] text-center text-[14px] leading-[1.45] text-[#8a8a8a]">
